  ...
  for (const r of records) {
    ...
    try {
      data = {
        ...
        trialMaxDays: parseNum(r.trialMaxDays ?? ""),
        trialMaxLessons: parseNum(r.trialMaxLessons ?? ""),
        trialPromoMaxDays: parseNum(r.trialPromoMaxDays ?? ""),
        trialPromoMaxLessons: parseNum(r.trialPromoMaxLessons ?? ""),
