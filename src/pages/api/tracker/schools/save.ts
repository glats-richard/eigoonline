...
export const POST: APIRoute = async ({ request }) => {
  ...
  const data: Record<string, any> = {
    ...
    trialMaxDays: toNumberOrNull(patch.trialMaxDays),
    trialMaxLessons: toNumberOrNull(patch.trialMaxLessons),
    trialPromoMaxDays: toNumberOrNull(patch.trialPromoMaxDays),
    trialPromoMaxLessons: toNumberOrNull(patch.trialPromoMaxLessons),
